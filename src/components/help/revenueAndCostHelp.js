  ...
  return (
    <div>
      ...
      <div className="role-allocation-container">
        ...
        <ol>
          <img src={ViewBtn} alt="" height={50} width={100} />
          <li>
            On Clicking of View button, Revenue & Cost Table of selected BU is displayed.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            Revenue & Cost Report of selected BU is generated and downloaded.
          </li>
        </ol>
      </div>
    </div>
