...
const CostUtilizationCostAnalysisHelp = () => {
  return (
    <div>
      <PageHeader>
        Cost Utilization - Cost Analysis
      </PageHeader>
      <div className="role-allocation-container">
        ...
        <ol>
          ...
          <li>
            On Clicking of View button, Cost Utilization Table of selected project is displayed.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            Cost Utilization Report of selected project is generated and downloaded.
          </li>
        </ol>
      </div>
    </div>
...
export default CostUtilizationCostAnalysisHelp;
