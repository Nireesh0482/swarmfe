  ...
  return (
    <div>
      ...
      <div className="role-allocation-container">
        ...
        <h1><b>Step 4. Click on View button</b></h1>
        <ol>
          <img src={ViewBtn} alt="View Button" height={50} width={100} />
          <li>
            On Clicking of View button, Project Revenue Table of all projects is displayed.
          </li>
        </ol>
        <h1><b>Step 5. Click on Export Data button</b></h1>
        <ol>
          <img src={ExportData} alt="Export Data" height={50} width={150} />
          <li>Project Revenue Report is generated and downloaded.</li>
        </ol>
      </div>
    </div>
  );
...
export default ProjectRevenueHelp;
