  ...
  return (
    <div>
      ...
      <div className="role-allocation-container">
        ...
        <h1><b>Step 4. Click on View button to display the Details of Project</b></h1>
        <ol>
          <img src={ViewBtn} alt="View Button" height={50} width={100} />
          <li>
            On Clicking of View button, Project Contribution Table of selected project(s) is displayed.
          </li>
        </ol>
        <h1><b>Step 5. Click on Export Data button</b></h1>
        <ol>
          <img src={ExportData} alt="Export Data" height={50} width={150} />
          <li>Project Contribution Report is generated and downloaded.</li>
        </ol>
      </div>
    </div>
  );
...
export default ProjectContributionHelp;
